...
- name: Youtube Delete Jobs Job
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/jobs/master/_listings/youtube/v1-jobs-jobid-delete.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/jobs/master/_listings/youtube/v1-jobs-jobid-delete-postman.md
x-common:
- type: x-articles
