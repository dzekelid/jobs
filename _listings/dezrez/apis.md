...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/jobs/master/_listings/dezrez/apis.md
specificationVersion: "0.14"
apis:
- name: Dezrez.Rezi.Client.Api - Gets the status for a job given its reference
  x-api-slug: apijob-get
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/jobs/master/_listings/dezrez/apijob-get-openapi.md
- name: Dezrez.Rezi.Client.Api - Issues a request that a job be cancelled if possbile
  x-api-slug: apijob-post
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/jobs/master/_listings/dezrez/apijob-post-openapi.md
- name: "Dezrez.Rezi.Client.Api - Sends a message to the LivePortalJobHandler that
    says \r\nthe specified property marketing role has changed"
  x-api-slug: apiadminsystemsendliveportalupdatemessage-post
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/jobs/master/_listings/dezrez/apiadminsystemsendliveportalupdatemessage-post-openapi.md
- name: Dezrez.Rezi.Client.Api - Issues a request that a job be cancelled if possbile
  x-api-slug: apijob-post
  description: Issues a request that a job be cancelled if possbile.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/28888-www-dezrez-com.jpg
